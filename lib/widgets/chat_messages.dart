   ...
   return StreamBuilder(stream:FirebaseFirestore.instance.collection('chat')
     ...
     return ListView.builder(
         ...
         itemBuilder: (ctx,index){
           ...
           final nextMessageUserId=nextChatMessage!=null ? nextChatMessage['username']:null;
           final nextUserIsSame=nextMessageUserId == currentMessageUserId;
           if(nextUserIsSame){
             return MessageBubble.next(message: chatMessage['text'], isMe: authenticateUser.uid==currentMessageUserId,);
           }
           else{
